...
import model.InfoMetodoSecante;
import model.MetodoSecante;

public class CtrlMetodoSecante extends TopBarController {

    @FXML private TableColumn<InfoMetodoSecante, Integer> colIteracion;
    @FXML private TableColumn<InfoMetodoSecante, Double> colX0;
    @FXML private TableColumn<InfoMetodoSecante, Double> colX1;
    @FXML private TableColumn<InfoMetodoSecante, Double> colX2;
    @FXML private TableColumn<InfoMetodoSecante, Double> colError;
    @FXML private TableView<InfoMetodoSecante> tblSecante;
    ...
    void ejecutar(ActionEvent event) {
        ...
        try {
            ...
            metodo.metodoSecante(x0, x1, error, maxIteraciones, tblSecante, userFunction);
